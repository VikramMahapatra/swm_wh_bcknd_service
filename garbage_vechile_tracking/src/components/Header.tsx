...
export default function Header() {
  ...
  const breadcrumbs = useMemo(() => {
    const segmentMeta: Record<string, { label: string; icon: typeof LayoutDashboard }> = {
      ...
      "gtc-checkpoint": { label: "GTS Checkpoint", icon: ClipboardCheck },
      "gts-dump-yards": { label: "GTS & Dump Yards", icon: Database },
      "dump-yard-weighment-entry": { label: "Dump Yard Weighment Entry", icon: Scale },
